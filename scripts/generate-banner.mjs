...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .glow-1 { width: 800px; height: 800px; right: -100px; top: -200px; background: rgba(104,239,63,0.06); }
    .glow-2 { width: 600px; height: 600px; left: -100px; top: -200px; background: rgba(104,239,63,0.04); }
    .glow-3 { width: 500px; height: 500px; left: 400px; bottom: -200px; background: rgba(104,239,63,0.03); }
...
<body>
  ...
  <div class="content">
    ...
    <div class="tagline">Soft skills training in Slack. Free forever.</div>
...
await page.screenshot({ path: 'public/images/linkedin-cover.png', type: 'png' });
await browser.close();
console.log('done');
